...
public class DecodingUtils {
    ...
    public static int[] decodeFastPfor128(byte[] encodedValues, int numValues, int byteLength, IntWrapper pos){
    ...
    public static float[] decodeFloatsLE(byte[] encodedValues, IntWrapper pos, int numValues){
        var fb = ByteBuffer.wrap(encodedValues, pos.get(), numValues * Float.BYTES).

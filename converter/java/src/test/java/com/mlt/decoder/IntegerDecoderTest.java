...
public class IntegerDecoderTest {
    ...
    public void decodeIntStream_SignedIntegerValues_PlainFastPforEncode(){
        ...
        var encodedStream = IntegerEncoder.encodeIntStream(values, PhysicalLevelTechnique.FAST_PFOR, true, StreamType.DATA);
        ...
        Assert.equals(LogicalLevelTechnique.NONE, streamMetadata.logicalLevelTechnique());
    }

    @Test
    public void decodeIntStream_SignedIntegerValues_PlainVarintEncode(){
        var values = List.of(1, 2, 7 ,3 , -4 , 5, 1, -8);
        var encodedStream = IntegerEncoder.encodeIntStream(values, PhysicalLevelTechnique.VARINT, true, StreamType.DATA);
    ...
    public void decodeIntStream_SignedIntegerValues_FastPforRleEncode(){
        ...
        Assert.equals(values, decodedValues);
        Assert.equals(LogicalLevelTechnique.RLE, streamMetadata.logicalLevelTechnique());
    }
    ...
    public void decodeLongStream_SignedIntegerValues_PlainEncode(){
        ...
        var encodedStream = IntegerEncoder.encodeLongStream(values, true, StreamType.DATA);
